...
public class OffersAdapters extends RecyclerView.Adapter<OffersAdapters.ViewHolder> {

        List<OffersModel> list;

public OffersAdapters(List<OffersModel> list) {
        this.list = list;
        }
...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder(@NonNull View itemView) {
        ...
        roundedImageView = itemView.findViewById(R.id.imgrecyc);
    }
}
}
